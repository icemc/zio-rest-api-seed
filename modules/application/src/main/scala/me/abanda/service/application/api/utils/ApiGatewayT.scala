package me.abanda.service.application.api.utils
...
import me.abanda.service.application.models.auth.Identity.StringToUserId
import me.abanda.service.application.models.auth.RequestId.{ DUMMY_REQUEST_ID, ToRequest }
import me.abanda.service.application.models.auth
import me.abanda.service.application.utils.Logging.Annotation.annotateWithRequest
import me.abanda.service.application.utils.Logging.logger
import me.abanda.service.application.models.auth.{ Identity, UserAwareRequest }
import me.abanda.service.application.utils.Logging
import me.abanda.service.application.utils.Metrics.Request
import me.abanda.service.application.utils.Metrics.Request.Internal
                ...
                if (failures.isEmpty || HiisRejectHandler.hasMethodMismatch(failure)) {
                  for {
                    ...
                    implicit0(_request: UserAwareRequest[Identity]) <- ZIO.succeed(
                      auth.UserAwareRequest[Identity](
                        request
